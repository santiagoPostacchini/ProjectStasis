...
public class PlayerMovement : MonoBehaviour
{
    ...
    [Tooltip("Velocidad al caminar (mantener Shift para aplicar)")]
    public float walkSpeed = 10f;
    [Tooltip("Velocidad al correr por defecto")]
    public float sprintSpeed = 15f;
    [Tooltip("Aceleración de la gravedad")]
    public float gravity = 9.81f;
    [Tooltip("Impulso de salto")]
    public float jumpSpeed = 3f;
    [Tooltip("Permite sprint")] public bool canSprint = true;
    [Tooltip("Permite salto")] public bool canJump = true;
    [Tooltip("Activa coyote time")]
    public bool coyoteTimeEnabled = true;
    [Tooltip("Duración de coyote time")]
    ...
    [HideInInspector] public bool IsMoveEnabled = true;
    ...
    public void HandleMovement()
    {
        ...
        // Sprint logic inverted: default rápido (sprint), mantener Shift para caminar lento
        ...
        Vector3 move = transform.TransformDirection(dir) * speed;

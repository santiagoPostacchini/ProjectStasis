...
namespace Player
{
    public class DetectorStasisObjects : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            _animProgress = Mathf.MoveTowards(_animProgress, target, Time.deltaTime * animSpeed);
            float t = animCurve.Evaluate(_animProgress);
        ...
        void DetectStasisObjects(Transform cam)
        {
            ...
            if(playerInteractor._objectGrabbable)
            {

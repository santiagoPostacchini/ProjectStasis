...
public class PhysicsBox : PhysicsObject, IStasis
{
    ...
    //[Header("Soporte de flotaci�n")]
    //[Tooltip("Transform que marca la posici�n en la que debe �flotar� el cubo al agarrarlo")]
    ...
    //[Header("Part�culas de energ�a")]
    //[Tooltip("ParticleSystem que genera el campo de energ�a")]
    ...
    public override void Grab(Transform grabPoint)
    {
        ...
        //// Detenemos el campo de part�culas
    ...
    {
        // 1) Si est� siendo agarrado, usar el grabPoint (Lerp hacia �l)
        ...
        //// 2) Si no est� agarrado y no est� en stasis, volver al soporte
        ...
        //    objRB.MoveRotation(cubeSupport.rotation);
        //}
        // 3) Si est� en stasis, mantener posici�n/rotaci�n congeladas
        else if (_isFreezed)
        {
